                ...
                <div class="solution_cards_box" id="menuBox">
                    <div class="solution_card">
                        ...
                        <div class="solu_title">
                            <h3><?php echo $menu->getNom() ?></h3>
                        </div>
                        <div>
                            <p class="entree">
                                <b>Entrées : <?php echo $menu->getEntree() ?> </b>
                            </p>
                            <p class="">
                                <b>+</b>
                            </p>
                            <p class="plat">
                                <b>Plats : <?php echo $menu->getPlat() ?> </b>
                            </p>
                            <p class="">
                                <b>+</b>
                            </p>
                            <p class="dessert">
                                <b>Desserts : <?php echo $menu->getDessert() ?> </b>
                            </p>
                        ...
                        <div class="solu_description">
                            ...
                            <p class="theme">
                                <b>Thème</b> : <?php echo $menu->getTheme() ?>
                            </p>
                            <p class="stock">
                                <b>Quantité restante</b> : <?php echo $menu->getQuantite_restante() ?>
                            </p>
                            <p class="condition">
