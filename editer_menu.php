                    ...
                    <div class="solution_card">
                        ...
                        <form id="monFormulaire" role="form" method="POST">
                            <div class="solu_title">
                                <h3 class="nom">
                                    <input name="nom" type="text" value="<?php echo $menu->getNom() ?>" required>
                                    </input>
                                </h3>
                            </div>
                            <div>
                                <p class="entree">
                                    <b>Entrées :
                                        <select name="entree[]" id="entree" class="form-multi-select" multiple
                                            ...
                                            <?php
                                            foreach ($entresOptions as $e) {
                                                echo '<option value="' . $e->getId() . '" ';
                                                if ($menu->menuHasEntree($e)) {
                                                    echo 'selected';
                                                }
                                ...
                                <p class="plat">
                                    <b>Plats :
                                        <select name="plat[]" id="plat" class="form-multi-select" multiple
                                            data-coreui-search="global">
                                            <?php
                                            foreach ($platsOptions as $p) {
                                                echo '<option value="' . $p->getId() . '" ';
                                                if ($menu->menuHasPlat($p)) {
                                                    echo 'selected';
                                                }
                                ...
                                <p class="dessert">
                                    <b>Desserts :
                                        <select name="dessert[]" id="dessert" class="form-multi-select" multiple
                                            data-coreui-search="global">
                                            <?php
                                            foreach ($dessertsOptions as $d) {
                                                echo '<option value="' . $d->getId() . '" ';
                                                if ($menu->menuHasDessert($d)) {
                                                    echo 'selected';
                                                }
                            ...
                            <div class="solu_description">
                                ...
                                <p class="description">
                                    <label class="theme_filter" for="description">Description</label>
                                    <textarea name="description" id="description" rows="4"
                                        cols="30"><?php echo $menu->getDescription() ?></textarea>
                                    </textarea>
                                </p>
                                <div class="nb_personne">
                                    <label class="theme_filter" for="nbPersonne">Nombre de Personne minimum</label>
                                    <input type="number" id="nbPersonne" class="theme_select_filter"
                                        onKeyDown="return false" name="nb_personne"
                                        value="<?php echo $menu->getNombre_personne_minimum() ?>" min="1" max="10"
                                        step="1">
                                </div>

                                <div class="prix_personne">
                                    <label class="theme_filter" for="prixPersonne">Prix par personne</label>
                                    <input type="number" id="prixPersonne" class="theme_select_filter"
                                        name="prix_personne" onKeyDown="return false"
                                        value="<?php echo $menu->getPrix_par_personne() ?>" min="1" max="1000" step="1">
                                </div>

                                <p class="regime">
                                    <label class="theme_filter" for="regime">Régime</label>
                                    <select name="regime" id="regime">
                                        <?php
                                        foreach ($regimeOptions as $r) {
                                            echo '<option value="' . $r . '" ';
                                            if ($menu->getRegime() == $r) {
                                                echo 'selected';
                                            }
                                ...
                                <p class="theme">
                                    <label class="theme_filter" for="theme">Thème</label>
                                    <select name="theme" id="theme">
                                        <?php
                                        foreach ($themeOptions as $t) {
                                            echo '<option value="' . $t . '" ';
                                            if ($menu->getTheme() == $t) {
                                                echo 'selected';
                                            }
                                ...
                                <div class="stock">
                                    <label class="theme_filter" for="stock">Quantité restante</label>
                                    <input type="number" id="stock" class="theme_select_filter" onKeyDown="return false"
                                        name="stock" value="<?php echo $menu->getQuantite_restante() ?>" min="1"
                                        max="200" step="1">
                                </div>

                                <p class="consition">
                                    <label class="theme_filter" for="condition">Conditions</label>
                                    <textarea name="condition" id="condition" rows="4"
                                        cols="30"><?php echo $menu->getCondition() ?></textarea>
                                    </textarea>
                                </p>
