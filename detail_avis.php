        ...
        <div class="profile-container">
                            ...
                            <form id="monFormulaire" role="form" method="POST">
                                <div>
                                    ...
                                    <input type="text" name="adresse" id="adresse"
                                        value="<?php echo $commande->getAdresseLivraison() ?>" readonly="readonly" />
                                    <div id="search_bar"></div>

                                    <label for="appt">Date et Heure de livraison :</label>
                                    <input type="datetime-local" id="appt" name="date_heure_livraison"
                                        value="<?php echo $commande->getDateHeureLivraison() ?>"
                                        min="<?php echo $todayDateTime ?>" readonly />
                                ...
                                <div>
                                    <p class="entree">
                                        <b>Entrées :
                                            <select name="entree" id="entree" disabled>
                                                <?php
                                    ...
                                    <p class="plat">
                                        <b>Plats :
                                            <select name="plat" id="plat" disabled>
                                                <?php
                                ...
                                <div class="solu_description">
                                    ...
                                    <div class="pick_list_container">
                                        ...
                                        <input type="number" id="personne-select" class="theme_select_filter"
                                            name="nb_personne" onKeyDown="return false"
                                            value="<?php echo $commande->getNombrePersonne() ?>"
                                            min="<?php echo $menu->getNombre_personne_minimum() ?>" max="10" step="1"
                                            disabled>
                                    </div>
                                    ...
                                    <p class="commande">
                                        <b>Commande</b> :
                                        <input type="number" name="totale_commande" id="totale_commande"
                                            value="<?php echo $commande->getPrixCommande() ?>" readonly></input>
                                    </p>
                                    <p class="livraison">
                                        <b>Livraison</b> :
                                        <input type="number" name="totale_livraison" id="totale_livraison"
                                            value="<?php echo $commande->getPrixLivraison() ?>" readonly></input>
                                    </p>
                                    <p class="distance_livraison">
                                        <b>Distance Livraison</b> :
                                        <input type="number" name="distance_livraison" id="distance_livraison"
                                            value="<?php echo $commande->getPrixDistanceLivraison() ?>" readonly>
                                        </input>
                                    ...
                                    <p class="reduction">
                                        ...
                                        <input type="number" name="reduction" id="reduction"
                                            value="<?php echo $commande->getReduction() ?>" readonly>
                                        </input>

                                    </p>
                                    <p class="prix_totale">
                                        <b>Prix Totale</b> :
                                        <input type="number" name="prix_totale" id="prix_totale"
                                            value="<?php echo $commande->getPrixTotale() ?>" readonly>
                                        </input>
                                    </p>
            ...
            <div class="container">
                <div class="main-content">
                    ...
                    <?php if (!$firstAvis): ?>
                        <p>Statut : <?php echo $avis->getStatut(); ?></p>
                    <?php endif; ?>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["REQUEST_URI"]); ?>" method="post">
                        ...
                        <textarea name="commentaire" value="<?php echo $avis->getCommentaire(); ?>" id="commentaire"
                            rows="4" cols="50" <?php if (!$editMode) {
                                echo "disabled";
                            } ?>><?php echo $avis->getCommentaire(); ?></textarea>
                        <br>
                        <?php if ($editMode): ?>
                            <button class="action-btn" type="submit" name="soumettre">Soumettre</button>
                        <?php endif; ?>

                        <?php if ($userIsEmploye && (!$editMode) && $avis->isAvisOpen()): ?>
                            <form action="traitement_trajet.php" method="post">
                                <button class="action-btn" type="submit" name="valider">Valider</button>
                                <button class="action-btn" type="submit" name="rejeter">Rejeter</button>
                            </form>
                        <?php endif; ?>
