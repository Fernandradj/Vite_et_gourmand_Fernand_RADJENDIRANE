                ...
                <form id="monFormulaire" role="form" method="POST">
                    ...
                    <div class="solu_description">
                        ...
                        <div class="nb_personne">
                            ...
                            <input type="number" id="nbPersonne" class="theme_select_filter" onKeyDown="return false"
                                name="nb_personne" min="1" max="10" step="1">
                        </div>

                        <div class="prix_personne">
                            <label class="theme_filter" for="prixPersonne">Prix par personne</label>
                            <input type="number" id="prixPersonne" class="theme_select_filter" name="prix_personne"
                                onKeyDown="return false" min="1" max="1000" step="1">
                        </div>
                        ...
                        <div class="stock">
                            ...
                            <input type="number" id="stock" class="theme_select_filter" onKeyDown="return false"
                                name="stock" min="1" max="200" step="1">
                        </div>

                        <p class="consition">
                            <label class="theme_filter" for="condition">Conditions</label>
                            <textarea name="condition" id="condition" rows="4" cols="30"></textarea>
                            </textarea>
                        </p>


                        <button id="submitBtn" type="submit" class="read_more_btn" name="creer">Enregistrer</button>
                    </div>
                </form>
            </div>
        </div>
